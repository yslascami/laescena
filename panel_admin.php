...
<body>
    <div class="sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="gestionar_artistas.php">Gestionar Artistas</a></li>
    ...
    <div class="main-content">
        ...
        <div style="margin-bottom:30px;">
            <a href="gestionar_artistas.php" class="btn-editar-artista" style="font-size:14px; padding:10px 20px;">Gestionar Artistas</a>
        </div>
